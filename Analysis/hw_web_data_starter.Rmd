...
```{r}
library(keyring)
# key_set("spotify_stephyspotifyr_client_id")
# key_set("spotify_stephyspotifyr_client_secret")

library(spotifyr)
Sys.setenv(SPOTIFY_CLIENT_ID = '94cebeda515b414e8b9fe12c8118adbe')
Sys.setenv(SPOTIFY_CLIENT_SECRET = '8df29b1e87fd42cb88cdbbdb0ed408de')

#access_token <- get_spotify_access_token(
#  client_id = key_get("spotify_stephyspotifyr_client_id"),
#  client_secret = key_get("spotify_stephyspotifyr_client_secret")
#)
