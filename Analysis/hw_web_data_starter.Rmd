...
- Does MPAA rating matter? Based on the plot, we can see that movies that are rated as "PG-13" of MPAA rating, the longer the movies are, the gross receipts are higher
```{r}
# for star_rating
oscar_movies %>% 
